  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center pt-16 pb-6 px-10 sm:px-16">
      ...
      {cartLoading || pizzaLoading || inventoryLoading ? (
        ...
        <div className="w-full mt-6 p-6 rounded-2xl shadow-lg bg-yellow-300">
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="w-full">
                  ...
                  <input
                    ...
                    disabled={true}
                    required
                    className="w-full text-yellow-600 bg-yellow-100 placeholder-yellow-300 rounded-md p-4 pr-12 text-sm shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
                <div className="w-full">
                    ...
                    switch (category) {
                      case 'bases':
                        return (
                          <div
                            key={category}
                            className="w-full flex flex-col items-center justify-center bg-yellow-100 rounded-md p-4"
                          >
