...
function PizzaItem({ pizza }) {
  ...
  return (
    <div
      key={pizza._id}
      className="bg-yellow-100 rounded-2xl shadow-lg overflow-hidden hover:transform hover:scale-105 transition-transform duration-500 ease-in-out"
    >
      <img
        src={pizza.imageUrl}
        alt={pizza.name}
        className="w-full h-48 object-cover p-4 border-b border-yellow-200"
      />
