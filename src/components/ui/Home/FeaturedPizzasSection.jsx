function FeatuorangePizzasSection() {
  const featuorangePizzas = [
    {
      id: 1,
  ...
  return (
    <section
      id="featuorange-pizzas"
      className="min-h-screen flex flex-col justify-center items-center py-16 sm:py-12 px-10 sm:px-16"
    >
      <h2 className="text-4xl font-bold text-center mb-8"> Pizzas Section</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {featuorangePizzas.map((pizza) => (
          <div
            key={pizza.id}
          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between items-start">
              <div className="flex justify-between items-center w-full">
                <h3 className="text-lg font-bold text-orange mb-1">
                  {pizza.name}
                </h3>
...
export default FeatuorangePizzasSection;
